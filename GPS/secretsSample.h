...
const char casterUser[] = "jane@doe.com"; // User must provide their own email address to use RTK2Go
const char casterUserPW[] = "";
const char mountPoint[] = "Your_Mount_Pt"; // The mount point you want to get data from
